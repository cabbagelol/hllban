...
-- 导出  事件 hllban.remove_expired_captchas 结构
DELIMITER //
...
-- 导出  事件 hllban.remove_expired_verifications 结构
DELIMITER //
...
-- 导出  事件 hllban.remove_old_messages 结构
DELIMITER //
